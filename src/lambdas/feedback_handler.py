"""Lambda handler for analyst feedback.

Captures the analyst's verdict on a draft. This is the human-in-the-loop
...
def _record(data: dict[str, Any]) -> dict[str, Any]:
    ...
    if data.get("analyst_notes"):
        item["analyst_notes"] = {"S": str(data["analyst_notes"])[:4000]}
